...
export default function KeyDetail({ loaderData }: Route.ComponentProps) {
  ...
  const failedLogs = [...r.usageLogs]
    .filter((l: KeyUsageLog) => !l.success)
    .sort(
      (a: KeyUsageLog, b: KeyUsageLog) =>
      ...
      {failedLogs.length > 0 && (
        <section>
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {failedLogs.map((log: KeyUsageLog, i: number) => (
      ...
      <section>
        ...
        {r.usageLogs.length === 0 ? (
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {r.usageLogs.map((log: KeyUsageLog, i: number) => (
                <tr key={i} className="border-b border-gray-800">
